...
def get_weather(zipcode):
    appid = 'f9a00de9d3574a3bb7d39d0d2a64ff38'
    baseurl = 'http://api.openweathermap.org/data/2.5/forecast?zip=%s&APPID=%s'
...
def generate_warnings(data):
   ...
   try:
       ...
       if (float(tomorrow_weather['main']['temp_min']) - float(today_weather['main']['temp_min']) <= -3 or
                       float(tomorrow_weather['main']['temp_max']) - float(today_weather['main']['temp_max']) <= -3):
           warnings[
